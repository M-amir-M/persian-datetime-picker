          ...
          FlutterError.reportError(
            FlutterErrorDetails(
              exception: FlutterError(
                ...
                'PersianCupertinoDatePicker because the parent is too narrow at '
                '${size.width}px.\n'
...
/// See also:
///
///  * [PersianCupertinoDatePicker], the class that implements different display modes
///    of the iOS-style date picker.
///  * [CupertinoPicker], the class that implements a content agnostic spinner UI.
enum PersianCupertinoDatePickerMode {
  /// Mode that shows the date in hour, minute, and (optional) an AM/PM designation.
  /// The AM/PM designation is shown only if [PersianCupertinoDatePicker] does not use 24h format.
...
// Different types of column in PersianCupertinoDatePicker.
...
///
/// There are several modes of the date picker listed in [PersianCupertinoDatePickerMode].
///
...
///
/// {@tool dartpad}
/// This sample shows how to implement PersianCupertinoDatePicker with different picker modes.
...
///
/// PersianCupertinoDatePicker can be displayed directly on a screen or in a popup.
///
...
class PersianCupertinoDatePicker extends StatefulWidget {
  /// Constructs an iOS style date picker.
  ///
  /// [mode] is one of the mode listed in [PersianCupertinoDatePickerMode] and defaults
  /// to [PersianCupertinoDatePickerMode.dateAndTime].
  ///
  /// [onDateTimeChanged] is the callback called when the selected date or time
  /// changes. When in [PersianCupertinoDatePickerMode.time] mode, the year, month and
  /// day will be the same as [initialDateTime]. When in
  /// [PersianCupertinoDatePickerMode.date] mode, this callback will always report the
  /// start time of the currently selected day. When in
  /// [PersianCupertinoDatePickerMode.monthYear] mode, the day and time will be the
  ...
  /// In [PersianCupertinoDatePickerMode.time] mode, [minimumDate] should typically be
  ...
  /// In [PersianCupertinoDatePickerMode.time] mode, [maximumDate] should typically be
  /// on the same date as [initialDateTime], as the picker will not limit the
  ...
  /// [PersianCupertinoDatePickerMode.date] mode. Defaults to 1.
  ///
  /// [maximumYear] is the maximum year that the picker can be scrolled to in
  /// [PersianCupertinoDatePickerMode.date] mode. Null if there's no limit.
  ///
  ...
  ///
  /// [dateOrder] determines the order of the columns inside [PersianCupertinoDatePicker]
  /// in [PersianCupertinoDatePickerMode.date] and [PersianCupertinoDatePickerMode.monthYear]
  ...
  /// The mode of the date picker as one of [PersianCupertinoDatePickerMode]. Defaults
  /// to [PersianCupertinoDatePickerMode.dateAndTime]. Value cannot change after
  /// initial build.
  final PersianCupertinoDatePickerMode mode;
  ...
  ///
  /// In [PersianCupertinoDatePickerMode.time] mode, a time becomes unselectable if the
  ...
  /// Determines the order of the columns inside [PersianCupertinoDatePicker] in
  /// [PersianCupertinoDatePickerMode.date] and [PersianCupertinoDatePickerMode.monthYear]
  /// mode. When using monthYear mode, both [DatePickerDateOrder.dmy] and
  /// [DatePickerDateOrder.mdy] will result in the month|year order.
  /// Defaults to the locale's default date format/order.
  ...
  State<StatefulWidget> createState() {
    ...
    return switch (mode) {
      ...
      PersianCupertinoDatePickerMode.dateAndTime =>
        _CupertinoDatePickerDateTimeState(),
      PersianCupertinoDatePickerMode.date => _CupertinoDatePickerDateState(
        dateOrder: dateOrder,
      ),
      PersianCupertinoDatePickerMode.monthYear =>
  ...
  static double _getColumnWidth(
    ...
    switch (columnType) {
      ...
      case _PickerColumnType.dayOfMonth:
        ...
        if (showDayOfWeek) {
          for (int wd = 1; wd < JalaliExt.daysPerWeek; wd++) {
...
class _CupertinoDatePickerDateTimeState
    extends State<PersianCupertinoDatePicker> {
  ...
  int get selectedDayFromInitial {
    switch (widget.mode) {
      case PersianCupertinoDatePickerMode.dateAndTime:
        return dateController.hasClients ? dateController.selectedItem : 0;
      case PersianCupertinoDatePickerMode.time:
        return 0;
      case PersianCupertinoDatePickerMode.date:
      case PersianCupertinoDatePickerMode.monthYear:
        break;
    }
    assert(
      false,
  ...
  @override
  void didUpdateWidget(PersianCupertinoDatePicker oldWidget) {
  ...
  double _getEstimatedColumnWidth(_PickerColumnType columnType) {
    estimatedColumnWidths[columnType.index] ??=
        PersianCupertinoDatePicker._getColumnWidth(
          columnType,
          localizations,
          context,
      ...
      child: CupertinoPicker.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          final String dateText =
              ...
              : localizations.datePickerMediumDate(rangeStart.toDateTime());
  ...
  bool _isValidHour(int meridiemIndex, int hourIndex) {
    ...
    final Jalali rangeEnd = rangeStart.addHours(1);
  ...
  void _pickerDidStopScrolling() {
    ...
    if (minCheck || maxCheck) {
      ...
      final Jalali targetDate = minCheck
          ? widget.minimumDate!
          : widget.maximumDate!;
  ...
  void _scrollToDate(Jalali newDate, Jalali fromDate, bool minCheck) {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.mode == PersianCupertinoDatePickerMode.dateAndTime) {
      switch (localizations.datePickerDateTimeOrder) {
        case DatePickerDateTimeOrder.time_dayPeriod_date:
        case DatePickerDateTimeOrder.dayPeriod_time_date:
...
class _CupertinoDatePickerDateState extends State<PersianCupertinoDatePicker> {
      ...
      child: CupertinoPicker(
        ...
        children: List<Widget>.generate(daysInCurrentMonth, (int index) {
          ...
          final int? dayOfWeek = widget.showDayOfWeek
              ? Jalali(selectedYear, selectedMonth, day).weekDay
              : null;
      ...
      child: CupertinoPicker(
        ...
        children: List<Widget>.generate(12, (int index) {
          ...
          final String monthName =
              (widget.mode == PersianCupertinoDatePickerMode.monthYear)
  ...
  bool get _isCurrentDateValid {
    ...
    final Jalali minSelectedDate = Jalali(
      selectedYear,
      selectedMonth,
      selectedDay,
    );
    final Jalali maxSelectedDate = Jalali(
      selectedYear,
      selectedMonth,
      selectedDay,
    ).addDays(1);
  ...
  void _pickerDidStopScrolling() {
    ...
    // Whenever scrolling lands on an invalid entry, the picker
    // automatically scrolls to a valid one.
    final Jalali minSelectDate = Jalali(
      selectedYear,
      selectedMonth,
      selectedDay,
    );
    final Jalali maxSelectDate = Jalali(
      selectedYear,
      selectedMonth,
      selectedDay,
    ).addDays(1);
...
class _CupertinoDatePickerMonthYearState
  ...
  void _refreshEstimatedColumnWidths() {
    estimatedColumnWidths[_PickerColumnType
        .month
        .index] = PersianCupertinoDatePicker._getColumnWidth(
      _PickerColumnType.month,
      localizations,
      context,
      false,
      standaloneMonth: widget.mode == PersianCupertinoDatePickerMode.monthYear,
    );
    estimatedColumnWidths[_PickerColumnType.year.index] =
        PersianCupertinoDatePicker._getColumnWidth(
          _PickerColumnType.year,
    ...
    return NotificationListener<ScrollNotification>(
      ...
      child: CupertinoPicker(
        ...
        onSelectedItemChanged: (int index) {
          selectedMonth = index + 1;
          if (_isCurrentDateValid) {
            widget.onDateTimeChanged(Jalali(selectedYear, selectedMonth));
          }
        },
        looping: true,
        selectionOverlay: selectionOverlay,
  ...
  bool get _isCurrentDateValid {
    // The current date selection represents a range [minSelectedData, maxSelectDate].
    final Jalali minSelectedDate = Jalali(selectedYear, selectedMonth);
    final Jalali maxSelectedDate = Jalali(
      selectedYear,
      selectedMonth,
  ...
  void _pickerDidStopScrolling() {
    ...
    // Whenever scrolling lands on an invalid entry, the picker
    // automatically scrolls to a valid one.
    final Jalali minSelectDate = Jalali(selectedYear, selectedMonth);
    final Jalali maxSelectDate = Jalali(
      selectedYear,
      selectedMonth,
      widget.initialDateTime.day,
